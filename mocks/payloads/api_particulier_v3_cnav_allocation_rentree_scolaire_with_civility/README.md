...
Enfant mineur `MERCIER PIERRE` de l'allocataire `MERCIER PIERRE` du cas Quotient Familial `200-1_parent_3_mineurs`. Né en 2013, il
respecte la condition d'âge ARS (6-18 ans) et est bénéficiaire.
