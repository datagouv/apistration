...
* [404.yaml](404.yaml)
  ...
  Payload INSEE Adresse établissement diffusable - not found 404
  ...
  curl -H "Authorization: Bearer $token" \
    ...
    --url "https://staging.entreprise.api.gouv.fr/v3/insee/sirene/etablissements/diffusibles/00000000000000/adresse"
  ```
