...
* [200-usager-base-france_connect.yml](200-usager-base-france_connect.yml)
  ...
  ```bash
  curl -H "Authorization: Bearer $token_france_connect" --url "https://staging.particulier.api.gouv.fr/v5/cnous/etudiant_boursier/identite?recipient=13002526500013"
  ```
