...
* [404.yaml](404.yaml)
  ...
  Payload INSEE Unités légales - not found 404
  ...
  curl -H "Authorization: Bearer $token" \
    ...
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/unites_legales/000000000"
  ```
...
* [association.yaml](association.yaml)
  ...
  ```json
  {
    ...
    "links": {
      "siege_social": "https://entreprise.api.gouv.fr/v4/insee/sirene/etablissements/77567227221138",
      "siege_social_adresse": "https://entreprise.api.gouv.fr/v4/insee/sirene/etablissements/77567227221138/adresse"
    },
    "meta": {
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/unites_legales/775672272"
  ```
...
* [association_regime_alsace_moselle.yaml](association_regime_alsace_moselle.yaml)
  ...
  ```json
  {
    ...
    "links": {
      "siege_social": "https://entreprise.api.gouv.fr/v4/insee/sirene/etablissements/42417936400023",
      "siege_social_adresse": "https://entreprise.api.gouv.fr/v4/insee/sirene/etablissements/42417936400023/adresse"
    },
    "meta": {
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/unites_legales/424179364"
  ```
...
* [personne_morale.yaml](personne_morale.yaml)
  ...
  ```json
  {
    ...
    "links": {
      "siege_social": "https://entreprise.api.gouv.fr/v4/insee/sirene/etablissements/55204944776279",
      "siege_social_adresse": "https://entreprise.api.gouv.fr/v4/insee/sirene/etablissements/55204944776279/adresse"
    },
    "meta": {
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/unites_legales/552049447"
  ```
...
* [personne_morale_etat_cesse.yaml](personne_morale_etat_cesse.yaml)
  ...
  ```json
  {
    ...
    "links": {
      "siege_social": "https://entreprise.api.gouv.fr/v4/insee/sirene/etablissements/35005144700018",
      "siege_social_adresse": "https://entreprise.api.gouv.fr/v4/insee/sirene/etablissements/35005144700018/adresse"
    },
    "meta": {
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/unites_legales/350051447"
  ```
...
* [personne_physique_diffusible.yaml](personne_physique_diffusible.yaml)
  ...
  ```json
  {
    ...
    "links": {
      "siege_social": "https://entreprise.api.gouv.fr/v4/insee/sirene/etablissements/47846480300319",
      "siege_social_adresse": "https://entreprise.api.gouv.fr/v4/insee/sirene/etablissements/47846480300319/adresse"
    },
    "meta": {
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/unites_legales/478464803"
  ```
...
* [personne_physique_non-diffusible.yaml](personne_physique_non-diffusible.yaml)
  ...
  ```json
  {
    ...
    "links": {
      "siege_social": "https://entreprise.api.gouv.fr/v4/insee/sirene/etablissements/35004292500031",
      "siege_social_adresse": "https://entreprise.api.gouv.fr/v4/insee/sirene/etablissements/35004292500031/adresse"
    },
    "meta": {
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/unites_legales/350042925"
  ```
