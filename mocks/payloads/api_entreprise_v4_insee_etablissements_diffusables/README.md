...
* [404.yaml](404.yaml)
  ...
  Payload INSEE Établissements diffusables - not found 404
  ...
  curl -H "Authorization: Bearer $token" \
    ...
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/etablissements/diffusibles/00000000000000"
  ```
...
* [association.yaml](association.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/etablissements/diffusibles/77567227221138"
  ```
...
* [association_regime_alsace_moselle.yaml](association_regime_alsace_moselle.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/etablissements/diffusibles/42417936400023"
  ```
...
* [personne_morale.yaml](personne_morale.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/etablissements/diffusibles/55204944776279"
  ```
...
* [personne_morale_etat_cesse.yaml](personne_morale_etat_cesse.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/etablissements/diffusibles/35005144700018"
  ```
...
* [personne_physique_diffusible.yaml](personne_physique_diffusible.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/etablissements/diffusibles/47846480300319"
  ```
...
* [personne_physique_non-diffusible.yaml](personne_physique_non-diffusible.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/etablissements/diffusibles/35004292500031"
  ```
