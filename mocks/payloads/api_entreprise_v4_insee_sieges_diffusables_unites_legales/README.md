...
* [404.yaml](404.yaml)
  ...
  Payload INSEE Sièges diffusables des unités légales - not found 404
  ...
  curl -H "Authorization: Bearer $token" \
    ...
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/unites_legales/diffusibles/000000000/siege_social"
  ```
...
* [association.yaml](association.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/unites_legales/diffusibles/775672272/siege_social"
  ```
...
* [association_regime_alsace_moselle.yaml](association_regime_alsace_moselle.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/unites_legales/diffusibles/424179364/siege_social"
  ```
...
* [personne_morale.yaml](personne_morale.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/unites_legales/diffusibles/552049447/siege_social"
  ```
...
* [personne_morale_etat_cesse.yaml](personne_morale_etat_cesse.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/unites_legales/diffusibles/350051447/siege_social"
  ```
...
* [personne_physique_diffusible.yaml](personne_physique_diffusible.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/unites_legales/diffusibles/478464803/siege_social"
  ```
...
* [personne_physique_non-diffusible.yaml](personne_physique_non-diffusible.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v4/insee/sirene/unites_legales/diffusibles/350042925/siege_social"
  ```
