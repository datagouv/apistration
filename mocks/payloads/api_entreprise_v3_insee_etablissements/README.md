...
* [200.yaml](200.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    ...
    --url "https://staging.entreprise.api.gouv.fr/v3/insee/sirene/etablissements/30613890001294"
  ```
...
* [404.yaml](404.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v3/insee/sirene/etablissements/00000000000000"
  ```
...
* [association.yaml](association.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v3/insee/sirene/etablissements/77567227221138"
  ```
...
* [association_regime_alsace_moselle.yaml](association_regime_alsace_moselle.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v3/insee/sirene/etablissements/42417936400023"
  ```
...
* [personne_morale.yaml](personne_morale.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v3/insee/sirene/etablissements/55204944776279"
  ```
...
* [personne_morale_etat_cesse.yaml](personne_morale_etat_cesse.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v3/insee/sirene/etablissements/35005144700018"
  ```
...
* [personne_physique_diffusible.yaml](personne_physique_diffusible.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v3/insee/sirene/etablissements/47846480300319"
  ```
...
* [personne_physique_non-diffusible.yaml](personne_physique_non-diffusible.yaml)
  ...
  curl -H "Authorization: Bearer $token" \
    -G -d 'recipient=10000001700010' -d 'context=Contexte+de+la+requ%C3%AAte' -d 'object=Objet+de+la+requ%C3%AAte' \
    --url "https://staging.entreprise.api.gouv.fr/v3/insee/sirene/etablissements/35004292500031"
  ```
