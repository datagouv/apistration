...
* [404.yaml](404.yaml)
  ...
  ```bash
  curl -H "Authorization: Bearer $token_france_connect" --url "https://staging.particulier.api.gouv.fr/v3/dss/prime_activite/france_connect?recipient=13002526500013"
  ```
