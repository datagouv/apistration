...
export class Cnous {
  ...
  async etudiant_boursier(options: { version?: number; recipient?: string; delegation_id?: string; campaign_year?: string } = {}) {
    ...
    const path = (() => {
      ...
      case 4:
        process.emitWarning('[DEPRECATED] /v4/cnous/etudiant_boursier/france_connect (#etudiant_boursier): marked deprecated in the OpenAPI spec.', 'DeprecationWarning');
        return `/v4/cnous/etudiant_boursier/france_connect`;
      case 5:
        return `/v5/cnous/etudiant_boursier/france_connect`;
        default:
          throw new Error(`version ${resolvedVersion} not available for /cnous/etudiant_boursier/france_connect; supported: [3,4,5]`);
      }
    })();
  ...
  async etudiant_boursier_identite(options: { version?: number; recipient?: string; delegation_id?: string; nom_naissance: string; prenoms: string[]; annee_date_naissance: string; mois_date_naissance: string; jour_date_naissance: string; sexe_etat_civil?: string; code_cog_insee_commune_naissance?: string; nom_commune_naissance?: string; code_cog_insee_departement_naissance?: string; campaign_year?: string }) {
    ...
    const path = (() => {
      ...
      case 4:
        process.emitWarning('[DEPRECATED] /v4/cnous/etudiant_boursier/identite (#etudiant_boursier_identite): marked deprecated in the OpenAPI spec.', 'DeprecationWarning');
        return `/v4/cnous/etudiant_boursier/identite`;
      case 5:
        return `/v5/cnous/etudiant_boursier/identite`;
        default:
          throw new Error(`version ${resolvedVersion} not available for /cnous/etudiant_boursier/identite; supported: [3,4,5]`);
      }
    })();
  ...
  async ine(options: { version?: number; recipient?: string; delegation_id?: string; ine: string; campaign_year?: string }) {
    ...
    const path = (() => {
      ...
      case 4:
        process.emitWarning('[DEPRECATED] /v4/cnous/etudiant_boursier/ine (#ine): marked deprecated in the OpenAPI spec.', 'DeprecationWarning');
        return `/v4/cnous/etudiant_boursier/ine`;
      case 5:
        return `/v5/cnous/etudiant_boursier/ine`;
        default:
          throw new Error(`version ${resolvedVersion} not available for /cnous/etudiant_boursier/ine; supported: [3,4,5]`);
      }
    })();
