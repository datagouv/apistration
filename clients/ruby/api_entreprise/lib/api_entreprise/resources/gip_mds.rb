...
module ApiEntreprise
  module Resources
    class GipMds
      ...
      def annee(siret, year, month, version: nil, profondeur: nil, nature_effectif: nil)
        ...
        @client.get(path, params: { "profondeur" => profondeur, "nature_effectif" => nature_effectif }.compact)
      end

      # Effectifs annuels d'une unité légale
      # Logical endpoint: /gip_mds/unites_legales/{siren}/effectifs_annuels/{year}
      # Versions available: [3] — default: 3
      def effectifs_annuels(siren, year, version: nil, nature_effectif: nil)
        ...
        @client.get(path, params: { "nature_effectif" => nature_effectif }.compact)
      end
    end
  end
end
