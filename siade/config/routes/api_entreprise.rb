...
namespace :v2, constraints: APIEntrepriseDomainConstraint.new  do
  ...
  get 'actes_inpi/:siren'                                 => '/api_entreprise/v2/actes_inpi#show'
  get 'bilans_inpi/:siren'                                => '/api_entreprise/v2/bilans_inpi#show'
...
scope path: 'v:api_version', constraints: APIEntrepriseDomainConstraint.new(v3_and_more: true) do
  ...
  get 'ministere_interieur/api-asso/associations/:siren_or_rna', to: 'api_entreprise/v3_and_more/mi/unites_legales#show'
  get 'ministere_interieur/api-asso/associations/open_data/:siren_or_rna', to: 'api_entreprise/v3_and_more/mi/unites_legales_open_data#show'
