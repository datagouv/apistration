...
scope path: 'v:api_version', constraints: APIEntrepriseDomainConstraint.new(v3_and_more: true) do
  get 'token/introspect', to: 'api_entreprise/v3_and_more/introspect#show'
  ...
  namespace :inpi do
    ...
    namespace :rne do
      ...
      get 'unites_legales/:siren/extrait_rne' => '/api_entreprise/v3_and_more/inpi/rne/extrait_rne#show'
    end
  end
  ...
  get 'ministere_interieur/siaf/associations/open_data/:siren_or_siret_or_rna', to: 'api_entreprise/v3_and_more/mi/siaf/associations_open_data#show'
  get 'ministere_interieur/siaf/associations/:siren_or_siret_or_rna', to: 'api_entreprise/v3_and_more/mi/siaf/associations#show'
