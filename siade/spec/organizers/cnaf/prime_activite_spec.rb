RSpec.describe CNAF::PrimeActivite, type: :retriever_organizer do
  ...
  describe '.call with civility params' do
    ...
    context 'when it is with transcogage params' do
      ...
      context 'with valid params for transcogage', vcr: { cassette_name: 'insee/metadonnees/one_result' } do
        let!(:stubbed_cnaf_request) do
          stub_cnaf_valid('prime_activite', extra_params: { codeLieuNaissance: '92036', dateNaissance: '2000-06-12' })
        end
    ...
    context 'when it is with code insee lieu de naissance' do
      ...
      describe 'happy path' do
        before do
          stub_cnaf_authenticate('prime_activite')
          stub_cnaf_valid('prime_activite')
        end
  ...
  describe '.call with FranceConnect params' do
    ...
    describe 'happy path' do
      before do
        stub_cnaf_authenticate('prime_activite')
        stub_cnaf_valid_with_franceconnect_data('prime_activite')
      end
