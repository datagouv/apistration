RSpec.describe SIADE::V2::Retrievers::BilansINPI do
  ...
  describe 'non existent siren', vcr: { cassette_name: 'inpi_bilans_not_found' } do
  ...
  describe 'valid siren', vcr: { cassette_name: 'inpi_bilans_valid_siren' } do
    let(:siren) { valid_siren(:inpi_pdf) }

    its(:success?) { is_expected.to be_truthy }
    it { is_expected.to be_delegated_to SIADE::V2::Drivers::INPI::Bilans, :bilans }
