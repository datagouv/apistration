RSpec.describe SIADE::V2::Requests::Infogreffe, type: :provider_request do
  ...
  context 'well formated request', vcr: { cassette_name: 'infogreffe_extrait_rcs_with_valid_siren' } do
