RSpec.describe SIADE::V2::Drivers::Infogreffe, type: :provider_driver do
  ...
  context 'when siren is valid', vcr: { cassette_name: 'infogreffe_extrait_rcs_with_valid_siren' } do
    ...
    its(:capital_social) { is_expected.to eq(509_525) }
    ...
    describe '#liste_observations' do
    ...
    describe '#mandataires_sociaux' do
      ...
      its([:date_naissance_timestamp]) { is_expected.to eq(-155_523_600) }
