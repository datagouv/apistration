RSpec.describe CIBTP::AttestationsMarchePublic::ValidateResponse, type: :validate_response do
  ...
  context 'with a 422 UnprocessableEntity response' do
  ...
  context 'with a 409 Conflict response' do
    let(:response) { instance_double(Net::HTTPConflict, code: '409') }
