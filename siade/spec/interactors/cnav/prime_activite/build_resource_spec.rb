RSpec.describe CNAV::PrimeActivite::BuildResource, type: :build_resource do
  subject { instance }
  ...
  let(:body) do
    read_payload_file('cnav/prime_activite/valid_beneficiaire_non_majore.json')
  end
  ...
  describe 'resource' do
    ...
    describe 'when beneficiaire is majore' do
      let(:body) do
        read_payload_file('cnav/prime_activite/valid_beneficiaire_majore.json')
      end
