RSpec.describe ANTSDossierImmatriculationSoapBuilder do
  # TEMPORARY: Keep request_id parameter for future use, but session_id currently uses old format
  ...
  # TEMPORARY: request_id parameter kept but not used in session_id yet
  ...
  before do
    ...
    # TEMPORARY: Re-adding old session_id mocks while using old format
    allow(SecureRandom).to receive(:hex).with(8).and_return('12345678')
    allow_any_instance_of(Object).to receive(:rand).with(10_000_000..99_999_999).and_return(87_654_321) # rubocop:disable allow_any_instance_of
  end
    ...
    it 'generates the correct SOAP envelope structure' do
      expected_xml = <<~XML
        ...
        <env:Envelope
          ...
          xmlns:ns1="http://siv.mi.fr/DefinitionsServices/2007-06"
        >
          <env:Header>
            <wsse:Security
              actor=""
            ...
            >
              <saml:Assertion ID="_0123456789abcdef0123456789abcdef" IssueInstant="2025-01-15T11:30:00Z" Version="2.0" xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion">
          ...
          <ds:Signature xmlns:ds="http://www.w3.org/2000/09/xmldsig#">
            <ds:SignedInfo>
              ...
              <ds:Reference URI="#_0123456789abcdef0123456789abcdef">
                ...
                <ds:DigestValue>3TofIVR53lG+XJj5OL9TjAshqA9iVo9d3ZV+ikzp+FY=</ds:DigestValue>
              </ds:Reference>
            </ds:SignedInfo>
          ...
          <saml:Conditions NotBefore="2025-01-15T11:30:00Z" NotOnOrAfter="2025-01-15T11:40:00Z"/>
          <saml:AuthnStatement AuthnInstant="2025-01-15T11:30:00Z">
            <saml:AuthnContext>
          ...
          <env:Body>
            ...
            >
              <ns1:control>
                <ns1:code_partenaire
                  >ants_siv_code_partenaire</ns1:code_partenaire
                >
                <ns1:code_miat>ants_siv_code_miat</ns1:code_miat>
                <ns1:type_operation>Consultation Dossier</ns1:type_operation>
                <ns1:numero_session>3-12345678.87654321</ns1:numero_session>
                <ns1:date_envoi
                  >2025-01-15T10:30:00</ns1:date_envoi
                >
              </ns1:control>
              <ns1:requete>
