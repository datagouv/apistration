  ...
  path '/v3/probtp/attestations_cotisation_retraite/{siret}' do
    get 'Récupération d\'une attestation' do
      ...
      describe 'with valid mandatory params', valid: true do
        response 200, 'Attestation found', vcr: { cassette_name: 'probtp/attestation/with_eligible_siret', match_requests_on: strict_match_vcr_requests_on_attributes } do
          let(:siret) { eligible_siret(:probtp) }
        ...
        response '404', 'Attestation non trouvée', vcr: { cassette_name: 'probtp/attestation/with_not_found_siret', match_requests_on: strict_match_vcr_requests_on_attributes } do
