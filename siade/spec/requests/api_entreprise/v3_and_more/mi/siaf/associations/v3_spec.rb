...
RSpec.describe 'MI - SIAF : Associations', api: :entreprise, type: %i[request swagger] do
  path '/v3/ministere_interieur/siaf/associations/{siren_or_siret_or_rna}' do
    get SwaggerData.get('siaf.associations.title') do
      tags(*SwaggerData.get('siaf.associations.tags'))
      ...
      describe 'with valid token and mandatory params', :valid do
        response 200, 'Association trouvée' do
          description SwaggerData.get('siaf.associations.description')

          schema build_rswag_response(
            attributes: SwaggerData.get('siaf.associations.attributes'),
            meta: SwaggerData.get('siaf.associations.meta')
          )
