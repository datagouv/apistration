...
RSpec.describe 'INSEE: Unités légales', api: :entreprise, type: %i[request swagger] do
  path '/v4/insee/sirene/unites_legales/{siren}' do
    get SwaggerData.get('insee.unite_legale_v4.title') do
      tags(*SwaggerData.get('insee.unite_legale_v4.tags'))
      ...
      describe 'with valid token and mandatory params', :valid do
        response '200', 'Unité légale trouvée', vcr: { cassette_name: 'insee/siren/active_GE_with_token' } do
          description SwaggerData.get('insee.unite_legale_v4.description')

          schema build_rswag_response(
            attributes: SwaggerData.get('insee.unite_legale_v4.attributes'),
        ...
        describe 'server errors' do
          ...
          common_provider_errors_request(INSEE::UniteLegale)
          common_network_error_request(INSEE::UniteLegale)
