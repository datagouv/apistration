...
RSpec.describe 'INSEE: Siège diffusible Unité Légale', api: :entreprise, type: %i[request swagger] do
  path '/v3/insee/sirene/unites_legales/diffusibles/{siren}/siege_social' do
