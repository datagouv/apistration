...
RSpec.describe 'API Particulier: CNOUS: Statut Etudiant with FranceConnect v5', api: :particulier, type: %i[request swagger] do
  path '/v5/cnous/etudiant_boursier/france_connect' do
        ...
        context 'when the student is found' do
          response '200', 'Étudiant identifié' do
            ...
            schema build_rswag_response(
              attributes: SwaggerData.get('cnous.commons.v5_attributes_without_identity')
            )
