RSpec.describe APIParticulier::CNAF::QuotientFamilialV2::V2, type: :serializer do
  ...
  let(:resource) { CNAF::QuotientFamilialV2::BuildResource.call(response:, params:).bundled_data.data }
  ...
  before do
    response['X-APISECU-FD'] = CNAF::QuotientFamilialV2::REGIME_CODE_CNAF
  end
