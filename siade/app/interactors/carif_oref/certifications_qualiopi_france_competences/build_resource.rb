  ...
  def resource_attributes
    {
      ...
      unite_legale_avec_plusieurs_nda: unite_legale['multinda'],
    ...
    valid_habilitations.map do |habilitation_payload|
      {
        ...
        actif: habilitation_payload['actif'],
        ...
        habilitation_pour_former: habilitation_payload['a_former'],
        habilitation_pour_organiser_l_evaluation: habilitation_payload['a_organiser'],
