class INSEE::CommuneINSEECode::BuildResource < BuildResource
  ...
  def find_commune_with_departement_code!
    valid_commune = communes.detect { |commune| commune['code'].start_with?(code_insee_departement_de_naissance) }
  ...
  def code_insee_departement_de_naissance
    context.params[:code_insee_departement_de_naissance]
  end
end
