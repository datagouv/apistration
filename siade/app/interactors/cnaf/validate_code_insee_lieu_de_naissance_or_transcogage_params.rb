class CNAF::ValidateCodeINSEELieuDeNaissanceOrTranscogageParams < ValidateParamInteractor
  def call
  ...
  def call_validator
    if code_insee_lieu_de_naissance?
      CNAF::ValidateCodeINSEELieuDeNaissance.call(params: context.params)
