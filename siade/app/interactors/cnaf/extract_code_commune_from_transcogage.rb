class CNAF::ExtractCodeCommuneFromTranscogage < ApplicationInteractor
  def call
    ...
    if extract_code_commune_organizer.success?
      context.params[:code_insee_lieu_de_naissance] = extract_code_commune_organizer.bundled_data.data.code_insee
    else
