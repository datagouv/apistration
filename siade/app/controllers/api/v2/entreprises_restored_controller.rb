class API::V2::EntreprisesRestoredController < API::AuthenticateEntityController
  def show
  ...
  def etablissement_siege
    EtablissementSerializer::V2.new(retriever_etablissement)
  end
