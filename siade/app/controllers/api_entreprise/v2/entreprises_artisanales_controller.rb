class APIEntreprise::V2::EntreprisesArtisanalesController < APIEntreprise::V2::BaseController
  def show
    ...
    if retrieve_entreprise.success?
      render json: APIEntreprise::EntrepriseArtisanaleSerializer::V2.new(retrieve_entreprise).as_json,
