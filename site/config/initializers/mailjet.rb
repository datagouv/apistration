...
Mailjet.configure do |config|
  config.api_key      = AdminApientreprise.credentials[:mj_apikey_public]
  config.secret_key   = AdminApientreprise.credentials[:mj_apikey_private]
  config.default_from = AdminApientreprise.credentials[:mj_default_from_email]
